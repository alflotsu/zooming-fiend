...
<svelte:head>
	<title>Sign In - Velourcity</title>
	<meta name="description" content="Sign in to your Velourcity account" />
</svelte:head>
	...
	<Card class="w-full max-w-lg">
		...
		<CardContent class="space-y-4">
			...
			<div class="text-center text-sm">
				...
				<a href="/auth/signup" class="underline underline-offset-4 hover:text-primary">
					Sign up
				</a>
			</div>

			<div class="text-center text-sm">
				<a href="/auth/forgot-password" class="text-muted-foreground underline underline-offset-4 hover:text-primary">
